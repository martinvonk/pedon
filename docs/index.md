...
The `pedon` package is open-source and hosted on [GitHub](https://github.com/martinvonk/pedon), where you can find more information about the ongoing developments. The package is published on [PyPi](https://pypi.org/project/pedon/) from which it can be installed using `pip install pedon`. If you use this software in your research or analyses, please cite the package via the Journal of Open Source Software:

> Vonk, M. A., & Peche, A. (2026). pedon: A Python package for analyzing unsaturated soil hydraulic properties. Journal of Open Source Software, 11(122), 10409. [https://doi.org/10.21105/joss.10409](https://doi.org/10.21105/joss.10409)
