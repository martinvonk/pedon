...
![Resulting Brooks-Corey SWRC and HCF after fitting on the Mualem-van Genuchten (`mg`) soil model \label{fig:swrc_fit}](figures/fit_swrc_hcf.png){height=5.0cm}
